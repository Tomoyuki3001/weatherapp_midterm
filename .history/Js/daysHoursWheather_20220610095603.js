...
function showWheatherData(data) {
  ...
  data.list.forEach((forecastObj) => {
    let date = forecastObj.dt_txt.slice(0, 11);
    let time = forecastObj.dt_txt.slice(11);
    ...
    // console.log("forecast", forecastObj.dt_date);

    // console.log(dateObject[propertyName], "dateObj");
    // console.log(forecastObj.dt_date, "forecastObj");
