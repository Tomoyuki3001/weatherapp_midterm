...
function showWheatherData(data) {
  ...
  for (let i = 0; i < 8; i++) {
    ...
    hoursCard.innerHTML = `
      ...
      <div>Feels like</div>
      <div class="days_temp_feels">${hoursData[i].main.feels_like}&#176C</div>
      <div class="days_pop"><span class="iconify days_pop_icon" data-icon="bi:cloud-rain-heavy" style="color: white; font-size: 17px;"></span>${
        hoursData[i].pop * 100
      }%</div>
    `;
